...
def render_groups(index_rows):
    ...
    lines = ["<!-- atlas-groups:start  (generated by tools/atlas/atlas_ingest.py from the vault's species_index.csv) -->",
             '<p class="atlas-total"><strong>Draft profiles for %d species so far</strong>, each with its Hindi and English names, identification, ecological role and references. Both the list and the profiles are still being revised.</p>' % total,
             '<p class="atlas-total-hi" lang="hi">अब तक %d प्रजातियों की प्रारूप प्रविष्टियाँ हैं, हर एक के हिंदी और अंग्रेज़ी नाम, पहचान, पारिस्थितिक भूमिका और संदर्भ के साथ। सूची और प्रविष्टियाँ, दोनों में अभी संशोधन चल रहा है।</p>' % total,
             '<p class="atlas-visit">Each has its own page, in Hindi and English, researched from the literature and still to be verified in the field. The photograph, where there is one, is a freely licensed reference image, not yet a record from the region. <a href="%s">Open the Awadh Biodiversity Atlas &rarr;</a></p>' % ATLAS_SITE,
             ...
             '<ul class="atlas-groups" aria-label="Draft profiles by group">']
